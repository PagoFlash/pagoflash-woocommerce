...
class WC_Gateway_Pagoflash extends WC_Payment_Gateway
{
  ...
  public function __construct()
  {
    ...
    #$this->icon = "{$pagoflash_woocommerce->base_url}/img/pf-icon.png";
    ...
    $this->title = $this->get_option('title')." (tarjeta de crédito Visa / Mastercard)";
    ...
    $this->form_fields = [
      ...
      'title' => [
        ...
        'description' => __('This controls the title which the user sees during checkout.',
          'pagoflash'),
        'default' => __('PagoFlash (tarjeta de crédito Visa / Mastercard)'),
        'desc_tip' => true,
        'custom_attributes' => [
          'required' => 'required'
        ]
